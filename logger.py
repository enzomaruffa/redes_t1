...
utils.create_log_terminal(sys.argv[1], output_file)
utils.create_log_terminal(sys.argv[2], output_file)
output_file.write("</div>\n")
output_file.write("<div class=\"row\">\n")
utils.create_log_terminal(sys.argv[3], output_file)
utils.create_log_terminal(sys.argv[4], output_file)
output_file.write("</div>\n")
